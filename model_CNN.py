...
path1 = 'E://BE Project//22SS137 Lungs  Cancer//lung cancer//training//0'    #path of folder of images    
path2 = 'E://BE Project//22SS137 Lungs  Cancer//lung cancer//training_set//0'  #path of folder to save images    
